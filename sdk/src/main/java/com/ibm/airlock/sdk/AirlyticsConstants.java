...
public class AirlyticsConstants {
        ...
        public static final String REST_EVENT_PROXY_HANDLER="com.ibm.airlytics.providers.RestEventProxyProvider";

        public static final String EVENT_LOG_PROVIDER_NAME="EVENT_LOG";
        public static final String EVENT_LOG_PROVIDER_HANDLER="com.ibm.airlytics.providers.EventLogProvider";

        public static final String DEBUG_BANNERS_PROVIDER_NAME="DEBUG_BANNERS";
        public static final String DEBUG_BANNERS_PROVIDER_HANDLER="com.ibm.airlytics.providers.DebugBannersProvider";

        public static final String STREAMS_EVENT_PROXY_NAME="STREAMS_EVENTS";
        public static final String STREAMS_EVENT_PROXY_HANDLER="com.ibm.airlock.sdk.airlytics.StreamsProvider";
