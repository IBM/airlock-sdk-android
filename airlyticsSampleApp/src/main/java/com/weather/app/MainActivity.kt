...
import com.weather.airlytics.AL.Companion.setUserAttributeGroups
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        try {
            ...
            AL.registerProviderHandlers(
                mapOf(
                    "REST_EVENT_PROXY" to "com.weather.airlytics.providers.RestEventProxyProvider",
...
//        events.removeAt(0)
//
//        environment = AL.updateEnvironment(environment.config, providers, events, "e79603a0-314b-4642-a765-8ece6732caf3", UUID.fromString("e79603a0-314b-4642-a765-8ece6732caf3"), this@MainActivity, mapOf("REST_EVENT_PROXY" to "com.weather.airlytics.providers.RestEventProxyProvider"), null, true)
//
...
//        )
    ...
    fun loadFeaturesFromAirlockAndUpdateAirlytics() {
        ...
        for (environmentFeatureItem in environments) {
            ...
            if (config != null) {
//                            AL.registerProviderHandlers(mapOf("REST_EVENT_PROXY" to "com.weather.airlytics.providers.RestEventProxyProvider"))
