...
class ALProviderHandlersTest {
    ...
    companion object{
        ...
        @BeforeClass @JvmStatic fun setup() {
            ...
            AL.registerProviderHandlers(mapOf("kafka" to "com.ibm.airlytics.providers.implementation.TestProviderHandler", "file" to "com.ibm.airlytics.providers.implementation.TestProviderHandler"))
        }
    }
    ...
    fun registerAlreadyExists() {
        ...
        try{
            AL.registerProviderHandlers(mapOf("kafka" to "com.ibm.airlytics.providers.implementation.TestProviderHandler"))
        }catch (ex : Exception){
    ...
    fun providerImplementationNotFound() {
        try{
            AL.registerProviderHandlers(mapOf("type1" to "com.ibm.airlytics.providers.ClassDoNotExist"))
    ...
    fun providerDoNotImplementCorrectly() {
        try{
            AL.registerProviderHandlers(mapOf("type2" to "com.ibm.airlytics.providers.implementation.TestWrongProviderHandler"))
