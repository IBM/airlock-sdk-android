...
import com.ibm.airlytics.providers.EventLogProvider
...
class ALEnvironmentTest {
    ...
    companion object{
        ...
        @JvmStatic fun setup() {
            ...
            AL.registerProviderHandlers(mapOf("kafka" to "com.ibm.airlytics.providers.implementation.TestProviderHandler", "kafka1" to "com.ibm.airlytics.providers.implementation.TestProviderHandler", "file" to "com.ibm.airlytics.providers.implementation.TestProviderHandler",
