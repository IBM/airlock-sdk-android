...
import com.ibm.airlytics.location.FusedLocationService
import com.ibm.airlytics.persistence.ALAndroidCache
import com.ibm.airlytics.providers.ALProviderException
...
import com.ibm.airlytics.utils.CrashHandler
...
class AL {
    ...
    companion object {
        ...
        fun createEnvironment(
            ...
            val environment = ALEnvironment(environmentConfig, context,
                userAttributesCache
            )
        ...
        fun setUserAttributeGroups(groups: JSONArray) {
            for (i in 0 until groups.length()) {
                ...
                for (j in 0 until groupValuesArray.length()) {
                    ...
                    userAttributeGroupsMap[attributeName] = i
